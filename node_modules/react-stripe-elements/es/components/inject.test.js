...
describe('injectStripe()', function () {
  ...
  describe('[sync]', function () {
    ...
    it('props.stripe.createPaymentMethod errors when an invalid type is passed in', function () {
      var Injected = (0, _inject2.default)(WrappedComponent);
      ...
      var props = wrapper.props();
      expect(function () {
        return props.stripe.createPaymentMethod('ideal');
      }).toThrow('Invalid PaymentMethod type passed to createPaymentMethod. ideal is not yet supported.');
    });
